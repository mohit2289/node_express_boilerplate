 ...
 * @description this is a category controller file has method to sync with micro-services to  perform crud operation
 */
const {
	handleSuccess,
	handleFailure,
...
exports.update = async (req, res) => {
	try {
		const { id, status, description, categoryPageBannerImage } = req.body;
		const payLoad = {
			categoryPageBannerImage,
			description,
